...
// import {deleteDeal } from "../../../State/admin/DealSlice";
// import {
//   Table,
//   TableBody,
//   TableCell,
...
//   useEffect(() => {
//     if (deals?.length) setDealList(deals);
//   }, [deals]);
...
//                 <StyledTableCell>
//                   <img
//                     src={deal.images?.[0] || "/default-deal.png"}
//                     alt={deal.name}
//                     style={{
//                       width: 60,
//                       height: 60,
...
//                 <StyledTableCell>{deal.categoryId || "N/A"}</StyledTableCell>
//                 <StyledTableCell>
...
//       {/* Edit Modal */}
//       {editDeal && (
//         <EditDealModal deal={editDeal} onClose={() => setEditDeal(null)} onSave={handleSave} />
//       )}
//     </>
//   );
// };
