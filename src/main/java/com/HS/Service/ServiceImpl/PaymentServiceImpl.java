...
import com.HS.Service.Service.PaymentService;
import com.HS.domine.PaymentOrderStatus;
...
public class PaymentServiceImpl implements PaymentService {
    ...
    public PaymentOrder createOrder(User user, Set<Order> orders) {
        ...
        if (amount <= 0) throw new RuntimeException("Payment amount cannot be zero or null");
    ...
    @Override
    public PaymentOrder getPaymentByPaymentId(String paymentLinkId) throws Exception {
    ...
    public Boolean ProceedPaymentOrder(PaymentOrder paymentOrder, String paymentId, String paymentLinkId) throws RazorpayException {
        if (!paymentOrder.getStatus().equals(PaymentOrderStatus.PENDING)) return false;
    ...
    @Override
    public PaymentLinkResponse createRazorpayPaymentLink(User user, Long amount, Long orderId) throws RazorpayException {
        amount = amount * 100;
        if (amount <= 0) throw new RazorpayException("Amount must be greater than zero");
